  ...
  return (
    <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-[100]">
      ...
      >
        ...
        <div className="text-[80px] font-bold text-foreground m-[1%]">
          404
        </div>
        ...
        <div className="flex gap-6 mt-8">
          <button
            ...
            className="text-foreground border-2 border-border hover:bg-muted hover:text-foreground transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 rounded-md"
          >
            <ArrowLeft
              size={20}
          ...
          <button
            ...
            className="bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105 rounded-md"
          >
            <Home
              size={20}
              className="transition-transform group-hover:translate-x-1"
...
function CircleAnimation() {
  ...
  const draw = () => {
    ...
    // Use theme-aware color for circles

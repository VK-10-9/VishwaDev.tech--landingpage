    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 pt-24 sm:pt-28 lg:pt-32 pb-12 sm:pb-16 md:pb-20">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">VishwaDev Labs</h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            VishwaDev Labs is a platform and SaaS company that builds custom tech solutions for clients. We partner with startups, enterprises, and organizations to deliver web apps, AI/ML, automation, mobile apps, and more—fast, reliably, and with full support.
          </p>
        ...
        <div className="text-center mt-16">
          ...
          <Button size="lg" asChild>
            <Link href="/contact">Contact VishwaDev Labs</Link>
          </Button>
        </div>
      </div>
    </div>

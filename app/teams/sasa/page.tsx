...
export const metadata: Metadata = {
  title: "SASA Team | VishwaDev",
  description: "Structural Intelligence, by design. The official SASA developer collective.",
};

export default function SasaTeamPage() {
  const team = teams.find((t) => t.id === "sasa");
  ...
  const coreValues = [
    { title: "DECOUPLED > COUPLING", desc: "Build isolated, self-contained components; eliminate spaghetti dependencies." },
    { title: "TYPESAFE CONTRACTS", desc: "Define strict, uncompromisable API models with zero untyped bypasses." },
    { title: "SCALE BY PROTOCOL", desc: "Formulate stateless, reproducible node environments designed to scale infinitely." }
  ];
            ...
            <div className="bg-white border-[3px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] rounded-xl p-6 sm:p-8">
              <div className="flex items-center gap-2.5 mb-6">
                ...
                <h3 className="font-black text-sm text-foreground uppercase tracking-widest">
                  Architects roster ({team.members.length})
                </h3>
              </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white border-[3px] border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] rounded-xl p-6 sm:p-8">
              <div className="flex items-center gap-2.5 mb-6">
                ...
                <h3 className="font-black text-sm text-foreground uppercase tracking-widest">
                  Structural blueprints ({team.projects.length})
                </h3>
              </div>
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center border-t border-dashed border-black/10 pt-2.5 mt-2 text-[10px]">
                      ...
                      <Badge className="bg-[#ffde47] hover:bg-[#ffde47] text-black border border-black font-black text-[9px] py-0.5 shadow-[1px_1px_0px_0px_rgba(0,0,0,1)]">
                        {index === 0 ? "Flagship Portal" : "Incubating"}
                      </Badge>
                    </div>
                  </a>
                ))}
